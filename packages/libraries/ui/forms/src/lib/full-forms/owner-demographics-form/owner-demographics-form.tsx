...
export interface OwnerDemographicsFormProps extends FullFormProps<Person> { }

const ownerAriaLabelPrefix = 'owner';
const addressFieldsPrefix: keyof Person = 'address';
const fullNameFieldsPrefix: keyof Person = 'name';

export function OwnerDemographicsForm(props: OwnerDemographicsFormProps) {
  // Build form prefix
  const ariaLabelPrefix = concatenateAriaLabelPieces(props.ariaLabelPrefix, ownerAriaLabelPrefix);
  // Render
  return (
    <FullFormCard
      formName={'Policy Owner Information'}
...
export default OwnerDemographicsForm;
